...
export default function HeaderSection() {
    return (
      <div
        className="bg-[#e6f7ff] bg-cover pb-7 pt-10"
        style={{
      ...
      >
        <div className="container mx-auto">
          <div className="text-center">
            <h2 className="text-4xl  font-black uppercase text-gray-900 md:tracking-[0.3em]">India&apos;s Largest AI Conference</h2>
            <Image alt="AI Days" className="mx-auto my-10 w-[700px] text-blue-600" src={horizontal.src}
              width={700} height={20}/>
            ...
            <div className="flex flex-col items-center justify-center gap-3 md:flex-row md:gap-0 md:space-x-10">
              <p className="text-lg text-gray-700">30 - 31 March 2024</p>
              <RegisterButton />

              <div className="flex justify-center space-x-10">
                <div className="text-center">
                  <p className="text-2xl font-bold text-blue-800">02</p>
                  <p className="text-sm uppercase tracking-wide text-gray-600">Days</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-blue-800">60+</p>
                  <p className="text-sm uppercase tracking-wide text-gray-600">Speakers</p>
                </div>
                <div className="text-center">
                  <p className="text-2xl font-bold text-blue-800">2000+</p>
                  <p className="text-sm uppercase tracking-wide text-gray-600">Delegates</p>
                </div>
              </div>
            </div>
          </div>
